...
### Apresentação da disciplina: que história é essa?

🎯 **Objetivos**

- Apresentar o curso e estabelecer os combinados com a turma
- Discutir o cenário atual dos usos de tecnologias digitais na pesquisa e no ensino de história

## AULA 2 (20/02/2025) 📖

### História e tecnologia: do código Morse aos LLMs

🎯 **Objetivos**

- Debater as definições de tecnologia, refletindo especialmente sobre a história do conceito e suas implicações sociais.
- Analisar os sentidos do termo História Digital, sua relação com os debates sobre tecnologia.
...
### Como a inteligência artificial “pensa” nosso curso?

🎯 **Objetivos**

- Discutir os impactos da inteligência artificial na historiografia e na produção de conhecimento.

⚠️ **Observação**: Atividade remota.

## AULA 4 (13/03/2025) 📖

### Passado, futuro e presente do digital na História

🎯 **Objetivos**

- Debater acerca dos elementos constitutivos da disciplina História e sua relação com as transformações e continuidades na era digital.
- Refletir sobre as mudanças de percepção do tempo e como isso pode afetar as formas de analisar e entender o passado e impactar nas formas de ensinar e narrar a História.
...
- Debater os impactos dos motores de busca e suas interfaces para a pesquisa em História.
- Avaliar os procedimentos de levantamento bibliográfico em meios virtuais.
- Analisar e experimentar a interface de buscas da Hemeroteca Digital Brasileira (HDB) da Biblioteca Nacional.
...
- Avaliar o uso de ferramentas de organização e gerenciamento de bibliografia para pesquisa e produção de trabalhos acadêmicos.
- Apreender os usos básicos do Zotero como ferramenta de organização de referências bibliográficas.
...
- O’NEIL, CATHY. Componentes da bomba. O que é um modelo? In: **Algoritmos de Destruição em massa**. São Paulo: Editora Rua do Sabão, 2020. pp. 25-50
...
### O Ensino de História na Era das IAs e das Fake News
...
- Introduzir o conceito de versionamento e sua importância para pesquisa histórica.
- Explorar ferramentas como Git e GitHub para documentação de pesquisas.
- Demonstrar práticas de reprodutibilidade na história digital.

📚 **Leitura obrigatória**

- Eric Brasil, “Git como ferramenta metodológica em projetos de História (parte 1)”, Programming Historian em português 3 (2023). [DOI](https://doi.org/10.46430/phpt0045)
...
### História Pública Digital e a divulgação científica
...
- Introduzir conceitos básicos de programação em Python.
- Explorar aplicações de Python para análise de dados históricos.
- Demonstrar a importância da programação para a história digital.

📺 **Materiais de Apoio**

- EM BREVE

## AULA 15 (30/05 a 04/06) 💻
